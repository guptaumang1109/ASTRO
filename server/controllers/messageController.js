...
export const imageMessageController = async (req,res) =>{
    try {
        ...
        const generatedImageUrl = `${process.env.IMAGEKIT_URL_ENDPOINT}/ik-genimg-prompt-${encodedPrompt}/astro/${Date.now()}.png?tr=w-800,h-800`;

        //Trigger geneartion by fetching from Imagekit
